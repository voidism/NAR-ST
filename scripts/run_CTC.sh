...
resume= #./exp/train_sp.en_lc.rm_pytorch_encoder_st_init_w_asr_correct_bpe8k_specaug_kdmt/results/snapshot.ep.13         # Resume the training from snapshot
seed=1          # seed to generate random number
# feature configuration
do_delta=false

preprocess_config=conf/specaug.yaml
train_config=conf/train_encoder_st_correct.yaml
...
# exp tag
tag="encoder_st_init_w_asr_correct_bpe8k_specaug_kdmt" # tag for managing experiments.
