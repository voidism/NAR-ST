...
train_config=conf/train_encoder_st_correct_multitask_seg6.yaml
...
# exp tag
tag="encoder_st_init_w_asr_correct_multitask_seg6_bpe8k_specaug_kdmt" # tag for managing experiments.
